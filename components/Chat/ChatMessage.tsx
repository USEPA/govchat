          ...
          {message.role === 'user' ? (
            ...
            <div className="flex flex-row">
              ...
              <MemoizedReactMarkdown
                ...
                rehypePlugins={[rehypeKatex, rehypeReference]}
                components={{
                  ...
                  th({ children, ...props }: any) {
                    return (
                      <th className="break-words border border-black bg-gray-500 px-3 py-1 text-white dark:border-white" {...props}>
                        {children}
                      </th>
                    );
                  },
                  td({ children, ...props }: any) {
                    return (
                      <td className="break-words border border-black px-3 py-1 dark:border-white" {...props}>
                        {children}
                      </td>
                    );
                  },
