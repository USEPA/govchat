    ...
    <>
      <div className="relative flex items-center">
        {isRenaming ? (
          ...
          <button
            className={`flex w-full cursor-pointer items-center text-black border border-neutral-200 gap-3 rounded-lg p-3 text-sm transition-colors duration-200 hover:bg-gray-500/10`}
